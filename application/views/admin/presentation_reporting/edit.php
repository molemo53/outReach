									...
									<div class="col-md-9">
										<div class="box border dark gray">
											...
											<span id="error" class='error'></span>
												<form class="form-horizontal" method="post" name="addStaff" id="addStaff" action="<?php echo site_url('admin/presentation_reporting/edit/'.base64_encode($certification[0]['document_id']));?>" role="form" enctype="multipart/form-data">
