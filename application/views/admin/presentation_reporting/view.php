      ...
      <!-- /Filter -->
							...
							<div class="col-md-12">
								...
								<div class="box solid gray">
									...
									<div class="tools hidden-xs">
											<a href="<?php echo site_url('admin/presentation_reporting/add');?>"><button class="btn btn-xs btn-inverse">Add New Presentation & Reporting</button></a>
										</div>
									</div>
									<div class="box-body">
                     ...
                     <?php $i=0; if(!empty($presentation_reporting_details)) {
                          ...
                          <!--  <a href="<?php //echo site_url('admin/presentation_reporting/detailview/'.base64_encode($row['document_id']));?>">
                                ...
                                -->
                                <a href="<?php echo site_url('admin/presentation_reporting/edit/'.base64_encode($row['document_id']));?>"><button class="btn btn-xs btn-warning"><i class="fa fa-pencil-square-o"></i> Edit</button></a>&nbsp;
&nbsp;
								<a onclick = "return confirm('are you sure want to delete the Presentation & Reporting ?');" href="<?php echo site_url('admin/presentation_reporting/Delete/'.base64_encode($row['document_id']));?>"><button class="btn btn-xs btn-danger"><i class="fa fa-exclamation-circle"></i> Delete</button></a>
													</td>
												</tr>
								<?php }
...
if(confirm('are you sure want to change the status?')) {
    if(staid>0){
		$.ajax({ 	
                    type: "POST",
                    url: "<?php echo base_url();?>presentation_reporting/Status",
