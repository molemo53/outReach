									...
									<div class="col-md-9">
										<div class="box border dark gray">
											...
											<span id="error" class='error'></span>
												<form class="form-horizontal" method="post" name="addStaff" id="addStaff" action="<?php echo site_url('admin/workshop_material/add');?>" role="form" enctype="multipart/form-data">
