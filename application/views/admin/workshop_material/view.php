      ...
      <!-- /Filter -->
							...
							<div class="col-md-12">
								...
								<div class="box solid gray">
									...
									<div class="tools hidden-xs">
											<a href="<?php echo site_url('admin/workshop_material/add');?>"><button class="btn btn-xs btn-inverse">Add New Workshop Material</button></a>
										</div>
									</div>
									<div class="box-body">
                     ...
                     <?php $i=0; if(!empty($workshop_material_details)) {
								foreach ($workshop_material_details as $row) {$i++;  ?>
													...
													<td>
                          <!--  <a href="<?php //echo site_url('admin/workshop_material/detailview/'.base64_encode($row['document_id']));?>">
                                <button class="btn btn-xs btn-success"><i class="fa fa-check"></i> View</button></a>&nbsp;
                                -->
                                <a href="<?php echo site_url('admin/workshop_material/edit/'.base64_encode($row['document_id']));?>"><button class="btn btn-xs btn-warning"><i class="fa fa-pencil-square-o"></i> Edit</button></a>&nbsp;
&nbsp;
								<a onclick = "return confirm('are you sure want to delete the Workshop Material ?');" href="<?php echo site_url('admin/workshop_material/Delete/'.base64_encode($row['document_id']));?>"><button class="btn btn-xs btn-danger"><i class="fa fa-exclamation-circle"></i> Delete</button></a>
													</td>
												</tr>
								<?php }
...
if(confirm('are you sure want to change the status?')) {
    if(staid>0){
		$.ajax({ 	
                    type: "POST",
                    url: "<?php echo base_url();?>workshop_material/Status",
