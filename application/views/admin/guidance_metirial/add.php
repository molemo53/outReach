							...
							<div class="col-sm-12">
								<div class="page-header">
									...
									<ul class="breadcrumb">
										...
										<li>Add New Guidance & Material</li>
									</ul>
									<!-- /BREADCRUMBS -->
									<div class="clearfix">
									...
									<div class="col-md-9">
										<div class="box border dark gray">
											...
											<span id="error" class='error'></span>
												<form class="form-horizontal" method="post" name="addStaff" id="addStaff" action="<?php echo site_url('admin/guidance_metirial/add');?>" role="form" enctype="multipart/form-data">
